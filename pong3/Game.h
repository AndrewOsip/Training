...
public:
    ...
    void boundPLayerColision(Ball& ball, Player& player, Bot& bot);
    void boundBotColision(Ball& ball, Player& player, Bot& bot);

    void playerColision(Ball& ball, Player& player);
    void botColision(Ball& ball, Bot& bot);
};
...
void Game::playerColision(Ball& ball, Player& player) {
...
void Game::botColision(Ball& ball, Bot& bot) {
...
void Game::boundPLayerColision(Ball& ball, Player& player, Bot& bot) {
    if(ball.y < 0) {
        ball.y = 0;
        ball.vy *= -1;
    }
...
void Game::boundBotColision(Ball& ball, Player& player, Bot& bot) {
