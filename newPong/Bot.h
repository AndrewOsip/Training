...
public:
    ...
    void botControl(IPlayer& bot, Ball& ball);
    SDL_Texture* displayScore(SDL_Renderer *render) ;
};

//________________________________________________

void Bot::botControl(IPlayer& bot, Ball& ball) {
...
SDL_Texture* Bot::displayScore(SDL_Renderer *render) {
    SDL_Texture *botScore = renderText(score, "/home/andrew/Sdl2/fonts/sample.ttf", whiteColor, 40, render);
    return botScore;
}
